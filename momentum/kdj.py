...
def kdj(high=None, low=None, close=None, length=None, signal=None, offset=None, mamode=None, **kwargs):
    """Indicator: KDJ (KDJ)"""
    # Validate Arguments
    ...
    k = ma(mamode, fastk, length=signal)
    d = ma(mamode, k, length=signal)
    j = 3 * k - 2 * d
