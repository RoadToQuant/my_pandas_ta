...
def smi(close, fast=None, slow=None, signal=None, scalar=None, offset=None, mamode='sma', **kwargs):
    ...
    # Calculate Result
    tsi_df = tsi(close, fast=fast, slow=slow, signal=signal, scalar=scalar, mamode=mamode)
    smi = tsi_df.iloc[:, 0]
